...
export class app extends outlook.view {
    ...
    config) {
        ...
        const Iproducts = this.get_Iproducts();
    ...
    async login(User) {
        ...
        const ids = await server.exec("mysql", [this.dbname], "get_sql_data", [sql]);
        // 
    ...
    async register() {
        ...
        const Role = new outlook.choices(this.config, inputs, "role_id");
        //
        //Get the user roles
