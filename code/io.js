...
export class select extends io {
    ...
    col) {
        ...
        choices.forEach((choice) => create_element(this.input, "option", { value: choice, textContent: choice }));
    }
    ///
...
export class url extends io {
    ...
    constructor(parent) {
        ...
        const url_label = create_element(this.document, `label`, { className: "edit", textContent: "Url Address: " });
        // 
        ...
        // 
        //Create a text label
        const text_label = create_element(this.document, `label`, {
...
export class foreign extends io {
    ...
    constructor(parent) {
        ...
        this.friendly = create_element(this.document, `span`, { className: "normal friendly" });
        //
        //Select a foreign key.
        //Note the class name button to allow us rstore this spcfic button
        //later
        this.button = create_element(this.document, `input`, {
...
export class file extends input {
    ...
    toggle_source(_evt) {
        ...
        const link = this.parent.get_element("theme_css");
        // 
...
export class primary extends io {
    ...
    constructor(parent) {
        ...
        //
        //The primary key doubles up as a multi selector
        this.multi_selector = create_element(this.document, "input", { type: 'checkbox', className: "multi_select" });
        //
        //Tag where to reporting  runtime errors that arise from a saving the record
        // (with this primary key to the server)
